...
namespace Task1
{
    internal class Program
    {
        ...
        public static Tank[] GetTanks()
        {
            ...
            return array; // Возвращаем массив резервуаров
        }
        ...
        public static Unit[] GetUnits()
        {
            ...
            return array; // Возвращаем массив установок
        }
        ...
        public static Factory[] GetFactories()
        {
            ...
            return array; // Возвращаем массив заводов
        }
        ...
        public static int GetTotalVolume(Tank[] tanks)
        {
            ...
            return summ; // Возвращаем общую сумму объемов
        }
